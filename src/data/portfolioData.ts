...
export const personalInfo = {
  ...
  socialLinks: {
    ...
    portfolio: "https://johanavs-portofolio.vercel.app/",
...
export const projects = [
  {
    ...
    image: "sentra",
    githubUrl: "https://github.com/Jjvers/Sentra",
    liveUrl: "",
    featured: true,
  },
  {
    ...
    image: "heartguard",
    githubUrl: "https://github.com/Jjvers/heart-guard",
    liveUrl: "",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    image: "study-buddy",
    githubUrl: "https://github.com/Jjvers/BrainFocusAI",
    liveUrl: "",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Jjvers/imgproo1",
    liveUrl: "",
    featured: false,
  },
  {
  ...
  organizational: [
    {
      ...
      organization: "PUMA Informatics, President University",
      period: "2025 – Present",
      category: "leadership" as const,
      description: "Oversee external communication, event supervision, and faculty-level event planning and execution",
      achievements: [
        "Lead division-level communication strategies between PUMA Informatics and external organizations",
        "Supervise and coordinate multiple large-scale organizational events",
        "Bridge faculty relations and internal committee for seamless event execution",
      ],
    },
    {
      id: "2",
      ...
      description: "Active member of the Internal Relations division, contributing to internal events and member engagement",
      achievements: [
        "Organized and executed welcoming & farewell ceremonies for PUMA Informatics members",
        "Collaborated with division teams to maintain strong internal communication",
        "Contributed to event logistics, documentation, and coordination",
      ],
    },
    {
      id: "3",
      role: "Project Manager – Unitics Welcome Event",
      organization: "PUMA Informatics, President University",
      period: "Dec 2024",
      category: "leadership" as const,
      description: "Led end-to-end planning and coordination for the PUMA Informatics internal welcoming event",
      achievements: [
        "Managed full event lifecycle from concept to execution",
        "Coordinated multi-team efforts across logistics, design, and documentation",
        "Successfully delivered the event within timeline and scope",
      ],
    },
    {
      id: "4",
      role: "Vice Project Manager – Inforum Farewell Event",
      organization: "PUMA Informatics, President University",
      period: "Jul 2025",
      category: "leadership" as const,
      description: "Co-led planning and logistics for the PUMA Informatics farewell celebration",
      achievements: [
        "Supported project manager in strategic planning and team delegation",
        "Managed event logistics, venue coordination, and rundown execution",
        "Ensured smooth and memorable farewell experience for outgoing members",
      ],
    },
    {
      id: "5",
      ...
      period: "2025 – 2026",
      category: "leadership" as const,
      description: "Mentored new members during onboarding; supervised an alumni workshop focused on AI & Computer Vision",
      achievements: [
        "Guided and mentored incoming PUMA Informatics members through onboarding processes",
        "Supervised the Alumni Workshop 2026 featuring AI & Computer Vision topics",
        "Ensured quality and relevance of workshop content and speaker coordination",
      ],
    },
    {
      id: "8",
      ...
      period: "2026",
      category: "leadership" as const,
      description: "Supervised the Company Visit 2026 to Tractor United Group, overseeing participant coordination and logistics",
      achievements: [
        "Led logistics planning and participant briefing for company visit to Tractor United Group",
        "Supervised on-site activities and ensured structured engagement with the host company",
        "Coordinated with internal teams and external contacts for seamless execution",
      ],
    },
  ],
};
